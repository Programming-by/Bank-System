...
private:
	...
	static void _ShowFindCurrencyScreen() {
		cout << "Currency Find Screen Will be here";

	}

	static void _ShowUpdateCurrencyRateScreen() {
		cout << "Currency Update Rate Screen Will be here";
	...
	static void _PerfromCurrenciesMainMenueOptions(enCurrenciesMainMenueOptions CurrenciesMainMenuOptions) {
